...
urlpatterns = [
    ...
    path('hr/meetings/', views.hr_meetings_view, name='hr_meetings'),
    path('hr/meetings/<int:pk>/', views.hr_meeting_detail_view, name='hr_meeting_detail'),
    path('hr/documents/', views.hr_documents_view, name='hr_documents'),
    path('hr/documents/<int:pk>/', views.hr_document_detail_view, name='hr_document_detail'),
