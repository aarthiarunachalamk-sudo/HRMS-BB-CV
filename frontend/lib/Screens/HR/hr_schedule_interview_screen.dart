...
class HrScheduleInterviewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final candidate = hrList(data, 'candidates').isEmpty
        ? <String, dynamic>{}
        : hrList(data, 'candidates').first;
    return ListView(
        ...
        ElevatedButton(
          ...
          onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Interview scheduling is not available yet.'),
              ),
            );
          },
