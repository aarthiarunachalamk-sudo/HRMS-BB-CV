...
class _HrEmployeeDirectoryScreenState
    extends State<HrEmployeeDirectoryScreen> {
  String _search = '';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text('${widget.employees.length} total',
          ...
          child: filtered.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.search_off_rounded, color: c.muted, size: 48),
        ...
        child: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    (isActive ? c.success : c.danger).withAlpha(25),
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                    color:
                        (isActive ? c.success : c.danger).withAlpha(100)),
              ),
              child: Text(status,
                  style: TextStyle(
