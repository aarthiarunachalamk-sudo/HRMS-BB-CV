              ...
              child: ListView(
                ...
                children: [
                  ...
                  _DrawerTile(
                    ...
                    label: 'Tasks',
                    selected: false,
                    onTap: () => _openAdminPage(const AdminTasksScreen()),
                  ),
                  _DrawerTile(
                    c: c,
                    ...
                    label: 'Assets',
                    selected: false,
                    onTap: () => _openAdminPage(const AdminAssetsScreen()),
                  ),
                  _DrawerTile(
                    c: c,
                    ...
                    label: 'Reports',
                    selected: false,
                    onTap: () => _openAdminPage(const AdminReportsScreen()),
                  ),
                  _DrawerTile(
                    c: c,
                    ...
                    label: 'Notifications',
                    selected: false,
                    onTap: () => _openAdminPage(const AdminNotificationsScreen()),
                  ),
                  _DrawerTile(
                    c: c,
                    ...
                    label: 'Settings',
                    selected: false,
                    onTap: () => _openAdminPage(const AdminSettingsScreen()),
                  ),
                  _DrawerTile(
                    c: c,
                    ...
                    label: 'Profile',
                    selected: false,
                    onTap: () => _openAdminPage(const AdminProfileScreen()),
                  ),
                ],
              ),
            ),
