...
class _DashboardViewState extends State<_DashboardView> {
  ...
  Widget build(BuildContext context) {
    ...
    return _ScreenScroll(
      colors: colors,
      children: [
        _IdentityCard(colors: colors, email: widget.email, name: widget.name),
        const SizedBox(height: 12),
        GridView.count(
          crossAxisCount: 2,
          shrinkWrap: true,
          ...
          children: [
            _MetricCard(
              ...
              color: colors.primary,
              onTap: () => widget.onOpenUsersFocus('employees'),
            ),
            _MetricCard(
              colors: colors,
              ...
              color: colors.blue,
              onTap: () => widget.onOpenUsersFocus('departments'),
            ),
            _MetricCard(
              colors: colors,
              title: 'Active Users',
              ...
              onTap: () => widget.onOpenUsersFocus('active_users'),
            ),
            _MetricCard(
              colors: colors,
              title: 'Attendance',
              ...
              color: colors.teal,
              onTap: () => widget.onOpenWorkflowFocus('attendance'),
            ),
            _MetricCard(
              colors: colors,
              ...
              onTap: () => widget.onOpenWorkflowFocus('leaves'),
            ),
            _MetricCard(
              colors: colors,
              title: 'Open Tasks',
              ...
              color: colors.danger,
              onTap: () => widget.onOpenWorkflowFocus('tasks'),
            ),
          ],
        ),
        ...
        _QuickActionGrid(
          colors: colors,
          onOpenCreateUser: widget.onOpenCreateUser,
...
class _SaColors {
  ...
  factory _SaColors.of(BuildContext context) {
    ...
    return _SaColors(
      ...
      primarySoft: const Color(0x1F0072FF),
